...
let gameElement = document.querySelectorAll('.gameElement');
...
$.get(CHEAPSHARK_API_URL, (data) => {
    ...
    function createGameElements() {
        for (let i = 0; i < gameList.length; i++) {
            ...
            newDiv.classList.add('container-fluid', 'col-3', 'border', 'border-2', 'rounded', 'd-flex', 'flex-column', 'gameElement');
            ...
            newPara1.classList.add('my-1')
            newPara2.classList.add('my-1')
            newPara3.classList.add('my-1')
