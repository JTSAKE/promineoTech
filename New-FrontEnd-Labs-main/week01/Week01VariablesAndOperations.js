...
let groceriesCost = 25.80;

console.log("Step 3:  Middle Initial");
let userMiddleInitial = 'A';

console.log("Step 4:  Is it Hot Outside?");
let hotOutside = false; 

console.log("Step 5:  First Name");
let customersFirstName = 'Billy';

console.log("Step 6:  Street Address");
let customersStreetAddress = '123 Street Name Ave';
...
//  ↓ YOUR CODE HERE ↓
    console.log(groceriesCost + 2.15);

    console.log('Fix a Birth Certificate:')
//	A birth certificate was printed incorrectly, change the middle initial to something else
//  ↓ YOUR CODE HERE ↓
    userMiddleInitial = 'J'
    console.log(userMiddleInitial)
...
//  ↓ YOUR CODE HERE ↓
    console.log(customersFirstName + ' ' + userMiddleInitial + ' ' + 'Jackson')

    console.log('Introduce a Customer:')
//	Print a line to the console that introduces the customer 
//	including the name, and saying that they live at the address variable
//  ↓ YOUR CODE HERE ↓
let customerFullName = customersFirstName + ' ' + userMiddleInitial + ' ' + 'Jackson';

console.log('Hi meet ' + customerFullName + ' they live at ' + customersStreetAddress);
