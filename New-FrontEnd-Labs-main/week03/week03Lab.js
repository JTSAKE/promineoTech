...
let splitArray = alphabetString.split()
console.log(`Using "split()": ${splitArray}`)

let stringChars = Array.from(alphabetString)
console.log(`Using "Array.from": ${stringChars}`)
...
let arrayReversed = alphabetArray.reverse()
console.log(arrayReversed)

console.log('Converted to a string')
 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
let myTodoList = []; //Creaing empty array

myTodoList.push('Laundry', 'Cooking', 'Meal Prep') //Pushing elements to empty array

console.log(myTodoList) //Confirming array has been populated

myTodoList.splice(1,1) // emoving second element in array

console.log(myTodoList) //Seeing change to array after splice()

let yourTodoList = []; //Creating new empty array

yourTodoList.push('Vaccum', 'Dishes') //Pushing elements to empty array

let ourTodoList = myTodoList.concat(yourTodoList); //Concatinating yourTodoList and myTodoList arrays together
